...
- [x] **Agent Architecture Doc:** Finalize 1–2 pages (all sections from PRD template).
...
- [x] **Demo video (3–5 min):** Agent in action, eval results, observability dashboard. Upload and link in submission.
